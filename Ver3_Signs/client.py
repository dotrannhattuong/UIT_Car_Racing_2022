...
def loop_and_detect(cam, trt_yolo, conf_th, vis):
    ...
    while True:
        ...
        # else:
        #     print(class_TS)
        #     canny_image = cv2.cvtColor(copyImage, cv2.COLOR_BGR2GRAY)
        #     canny_image = canny_image[250:, :]
        #     canny_image = cv2.resize(canny_image, (canny_image.shape[1]//2, canny_image.shape[0]//2))
        ...
        sendBack_angle, sendBack_speed = Control(pred, sendBack_speed=28, height=10, signal=class_TS, area=np.median(lst_area))
