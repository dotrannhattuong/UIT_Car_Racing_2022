...
class Controller:
    ...
    def __turnright(self):
        ...
        self.__timer_intersection(time_straight=0.2, time_turn=1, velo=15, angle_turn=-25)

    def __turnleft(self):
        print('Leftttttttttttttttttttttt')
        self.__timer_intersection(time_straight=0.2, time_turn=1, velo=15, angle_turn=35)
    
    def __straight(self):
        print('Straightttttttttttttttttt')
        self.__timer_intersection(time_straight=0.1, time_turn=-1, velo=15, angle_turn=-1)
    ...
    def __call__(self, frame, sendBack_speed, height, signal, area):
        ...
        if signal != 'None' and 1000 <= area <= 2500:
            sendBack_speed = 10
